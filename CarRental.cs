...
namespace OopLab03
{
    public class CarRental : RentalTransaction
    {
        ...
        // constructor
        public CarRental(int transactionId, DateTime rentalStartDate, DateTime rentalEndDate, string customerName)
        ...
        {
            // for calculating rent of car
            // first we will calculate number of days for which car is rented is going to total days multiplied by 
